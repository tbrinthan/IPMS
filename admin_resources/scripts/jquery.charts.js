(function($)
{
	...
	$.fn.charts = function (settings) {
		...
		var config = {
			...
			duration: 2000,
			showoriginal: false,
			chartbgcolours: ["#336699", "#662233", "#339966","#322699","#886699", "#772233", "#311266","#367856"],
			chartfgcolours: ["#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF","#FFFFFF", "#FFFFFF", "#FFFFFF", "#FFFFFF"],
			chartpadding: 8,
			chartheight: 350,
			//showlabels: true,
			showgrid: true,
			...
			if (config.showgrid) {
				...
				for (var i = 0; i < gridLineCount; i++) {
                    ...
                    if (config.gridvalues) {
                        var value = Math.round(((gridLineCount - i) * gridLineValue));

...
<div class="content-box" xmlns="http://www.w3.org/1999/html"><!-- Start Content Box -->
    ...
    <div class="content-box-content" >
        ...
        <form  action="#" method="post" id="addtempcustomerform" >
            <fieldset>
                <div id="customer_add">
                <b>Customer Name&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</b>   <input class="text-input small-input" type="text" id="txtCustomer"  size="24"/>
                    <p></p>

                    <b>Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</b>   <input class="text-input small-input" type="text" id="txtAddress"  size="24" />
                    <p></p>
                <b>BandWidth&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</b>   <input class="text-input Small-input" type="text" id="txtBW"  size="8" />
                    <p></p>


                    <b>Connection Type&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</b>   <input class="text-input Small-input" type="text" id="txtConn"  size="8" />
                    <p></p>

                    <b>End Date&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;</b>   <input class="text-input Small-input" type="text" id="txtEndDate"  size="8" />
                    <p></p>

                    <div class="clear"></div>
                    <p></p>
                    <input class="button" id="add_temp_cust" type="button" value="Add Temp Customer" style="display:block; height: 40px; font-variant:small-caps; " onclick="add_Temp_Customer()"/>
            ...
            <div style="display:none;" id="temp_cust_detail">
                <hr/>
                <div class="clear"></div>
      ...
      <span> <input class="button" id="add_private_ip" type="button" value="Add Private IPs" style="display:none;margin-left: 50px; height: 40px; font-variant:small-caps; " onclick="add_PrivateIP_to_Customer()"/>
                </p>
